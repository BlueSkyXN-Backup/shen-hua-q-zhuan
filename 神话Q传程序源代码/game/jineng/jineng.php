...
case "gongji":
$html="攻击".$jineng_u['2']."个目标".$jineng_u['0']."次,并造成造成".$gongji_leixing."(+".$jineng_u['10'].")伤害。造成伤害时：伤害强化为".$jineng_u['9']."倍";
$html2="攻击".$jineng_n['2']."个目标".$jineng_n['0']."次,并造成造成".$gongji_leixing."(+".$jineng_u['10'].")伤害。造成伤害时：伤害强化为".$jineng_n['9']."倍";
break;
