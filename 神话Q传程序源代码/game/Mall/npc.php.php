...
echo "<a href='./npc.php?my=jiben'>基本</a>|<a href='./npc.php?my=zhuangbei'>装备</a>|<a href='./npc.php?my=cailiao'>材料</a>|<a href='./npc.php?my=xiaohao'>药品</a> <br/>";
if($Mall_name=="zhuangbei"){
//装备
$perNumber=8; 
$page=$_GET['page']; 
$url="/Mall/npc.php?my=$Mall_name&";
$total=mysqli_fetch_array(mysqli_query($db,"select count(*) from shangcheng WHERE shei='2' and shangpin_leixing='".$Mall_name."'")); 
$totalNumber=$total[0]; 
...
$exec="select * from shangcheng WHERE shei='2' and shangpin_leixing='".$Mall_name."' order by id desc limit $startCount,$perNumber";
